...
{
	public class AfiDatePicker : DateTimePicker
	{
		//Fields
		...
		private bool droppendDown = false;
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			using (StringFormat textFormat = new StringFormat())
			{
				...
				if (droppendDown == true) graphics.FillRectangle(openIconBrush, iconArea);
				//Draw border 
